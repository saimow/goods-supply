                ...
                <div class="border border-secondary border-opacity-50 p-3 bg-light">
                    <div class="row">
                        <div class="col-xl-3">
                            ...
                            <div>
                                <img class="border border-secondary border-opacity-50 rounded img-fluid variant-image" :src="variant.image ? '/storage/products/media/' + variant.image : '/imgs/no-image.png'"  data-bs-toggle="modal" :data-bs-target="'#image'+index">
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="d-flex flex-row">
                                    <div v-for="(image, key) in media" :key="key" class="me-2" :class="image.name == variant.image ? 'border border-primary border-3 rounded-1' : 'border border-secondary-500 border-3 rounded-1'">
                                        <img @click="setSelectedImage(image.name, index, variant.image)" :src="'/storage/products/media/'+image.name" class="image-listing ">
                                    </div>
                                </div>
                            </div>
...
import Multiselect from '@vueform/multiselect'
    ...
    export default {
        ...
        methods:{
            ...
            updateOptions(index){
                if(this.variants.length && this.options[index].values.length){
                    this.variants.forEach((variant, vindex) => {
